...
public class DataAdapter_Favorit  extends RecyclerView.Adapter<DataAdapter_Favorit.DatakuViewHolder> {
    private List<Team_ModelRealm> dataList;
    ...
    public DataAdapter_Favorit(List<Team_ModelRealm> dataList, Callback callback) {
    ...
    public void onBindViewHolder(final DatakuViewHolder holder, final int position) {
        holder.txtNama.setText(dataList.get(position).getTeamName());
        holder.txtCntry.setText(dataList.get(position).getCountry());
    ...
    public class DatakuViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        private TextView txtNama, txtCntry;
        CardView card;
        ImageView ivBadge;
        ...
        public DatakuViewHolder(View itemView) {
            ...
            txtCntry = (TextView) itemView.findViewById(R.id.tvcountry);
